...
data_directory = "/experimental_pdb"
data_directory_regression = "/regression_labels_situs"
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        density_map = f"{data_directory_regression}/{values}_regression_situs.mrc"
        # density_map = f"{map_data_directory}/{values}_het_box_regression.mrc"
        pdb_file = f"{map_data_directory}/{values}.pdb1"
        logs = f"{map_data_directory}/reg_mtriage.out"
